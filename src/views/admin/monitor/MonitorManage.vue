<template>
  <main id="monitor_manage__container">
    <ProgressTimeStandardSetting v-if="getSelectedContentViewSubtitle === 1" />
...
import ProgressTimeStandardSetting from "@/views/admin/monitor/ProgressTimeStandardSetting.vue";
